...
import { decodeBinaryData, encodeXmlString } from './EncodeDecode';
        ...
        decodeBinaryData(message.data)
            .then((xmlString) => {
                if (xmlString.indexOf('<open ') === 0 || xmlString.indexOf('<?xml') === 0) {
                    ...
                    const parsedMessage = new DOMParser().parseFromString(xmlString, 'text/xml').documentElement;
        ...
        decodeBinaryData(message.data)
            .then((xmlString) => {
                ...
                if (xmlString === close) {
                    ...
                    elem = new DOMParser().parseFromString(xmlString, 'text/xml').documentElement;
